<template>
  <div class="player-controls" :class="myclass">
    <div class="player-controls__item -favorite" :class="{ active : playerMode.currentTrack.favorited }" @click="favorite">
      <svg class="icon">
        <use xlink:href="#icon-heart-o"></use>
      </svg>
    </div>
    <a :href="playerMode.currentTrack.url" target="_blank" class="player-controls__item">
      <svg class="icon">
    ...
    <div class="player-controls__item -xl js-play" @click="play">
      <svg class="icon">
        <use xlink:href="#icon-pause" v-if="playerMode.isTimerPlaying"></use>
        <use xlink:href="#icon-play" v-else></use>
      </svg>
    </div>

    <svg xmlns="http://www.w3.org/2000/svg" class="hidden" xmlns:xlink="http://www.w3.org/1999/xlink">
      <defs>
...
export default {
  ...
  computed: {
    myclass() {
      return this.playerMode.type == "min" ? "player-controls-min" : "";
    }
  },
  methods: {
    prevTrack() {
    ...
    favorite() {
      let { currentTrackIndex, tracks } = this.playerMode.getData();
      tracks[currentTrackIndex].favorited = !tracks[currentTrackIndex]
        .favorited;
